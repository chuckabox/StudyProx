  ...
  return (
    <div className="card-scholar min-h-[600px] flex flex-col p-0!">
      ...
      <div className="px-12 py-10 border-b border-ink/5 flex justify-between items-center bg-paper/30 backdrop-blur-sm">
        ...
        <button 
          onClick={onCancel}
          className="p-3 hover:bg-ink/5 rounded-full text-muted hover:text-ink"
        >
          <X className="w-6 h-6" />
        </button>
      </div>
      ...
      <div className="flex-1 px-12 py-16 flex flex-col">
        {step === 'input' && (
          <div className="space-y-12 flex-1 flex flex-col justify-center max-w-lg mx-auto w-full">
        ...
        {step === 'decomposing' && (
          <div className="flex-1 flex flex-col items-center justify-center space-y-8">
            <div className="relative">
              <div className="absolute inset-0 bg-ink/5 rounded-full scale-[2]" />
              <Loader2 className="w-16 h-16 text-ink relative z-10" />
            </div>
                ...
                <div className="space-y-6">
                  {subtasks.map((st, i) => (
                    <div 
                      ...
                      className={cn(
                        "relative group",
                        i === 0 ? "card-scholar border-ink/20! shadow-xl shadow-ink/5" : "pl-12 opacity-40 hover:opacity-100"
                      )}
                    >
                      {i === 0 && (
